...
let app = express();
let port = process.env.PORT || 7888;
let apiurl = "http://api.openweathermap.org/data/2.5/forecast/daily?q=Paris&mode=json&units=metric&cnt=5&appid=fbf712a5a83d7305c3cda4ca8fe7ef29"
...
app.listen(port,(err) => {
 ...
 //var myobj = {city:output.city.name,data:output.list}
 //res.send(myobj)